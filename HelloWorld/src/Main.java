...
/** 4.METHODES USUELLES      -non- **/
    ...
    public static void main(String[] args) {
        ...
        Ingredient ingredient10;// On cr�e le pointeur ingredient10,
        ingredient10 = new Ingredient("lait",10); // On cr�e l'objet <"lait",10> et le pointeur ingredient10 r�cup�re l'adresse de l'objet <"lait",10>
        System.out.println(ingredient10.toString()); // On affiche la valeur de ingredient10
        ...
        System.out.println("\n2. Cas de l'objet reference par deux pointeurs");
        Ingredient ingredient21; // a. cr�ation d'un 1er pointeur ingredient21
        Ingredient ingredient22;// a. cr�ation d'un 2eme pointeur ingredient22
        ingredient21 = new Ingredient("sel", 21); // b. le 1er pointe sur new objet <"sel", 21>
        ingredient22 = ingredient21; // c. copier l'@ de l'objet dans le 2�me pointeur
        ingredient21.afficher(); // d. affichage via 1er pointeur
        ingredient22.afficher(); // d. affichage via 2�me pointeur
        ingredient21.set_quantite(15);// e. modifier l'objet via le 1er pointeur
        ingredient21.afficher(); // f. affichage via 1er pointeur
        ingredient22.afficher(); //    et 2�me pointeur
        ...
        Ingredient ingredient31;// b. cr�e le 1er pointeur    ingredient31
        ingredient31 = new Ingredient("milk", 31); // b. le 1er pointeur prend l'@ d'un ouvel objet <"milk", 31>
        Ingredient ingredient32; // c. cr�e le 2�me pointeur   ingredient32
        ingredient32 = new Ingredient(ingredient31); // c. le 2�me pointeur prend l'@ du 2�me objet qui est construit sur la base du 1er objet, cad construit par recopie
        ...
        ingredient31.set_quantite(25); // e. modification de l'un des 2 objets
        ingredient31.afficher(); ingredient32.afficher(); // f. affichage de ce que pointent ingredient31 et ingredient32
        ...
        Ingredient ingredient41 = new Ingredient("salt", 41); // a. cr�er un objet <"salt", 41> point� par ingredient41
        Ingredient ingredient42 = ingredient41; // b. copier le pointeur dans un second pointeur ingredient42
        ...
        Ingredient ingredient43 = new Ingredient("vin", 49); // a. cr�er un objet point� par ingredient43 aux valeurs <"vin", 49>
        Ingredient  ingredient44 = new Ingredient("vin", 49);// b. cr�er un 2�me objet point� par ingredient44 aux m�mes valeurs <"vin", 49>
        if(ingredient43.equals(ingredient44)){
            System.out.println("Les ingrédients sont égaux");
